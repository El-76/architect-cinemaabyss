...
* Переменная MOVIES_MIGRATION_PERCENT выставлена в 25
* Сервисы monolith и movies-service модифицированы так, чтобы они добавляли заголовок X-Server-Name - так видно, какой сервис за proxy обслужил запрос
